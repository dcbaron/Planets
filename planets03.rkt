...
;; with semaphore-waiting.
;;
;;
;; I have further modified my planets02 file to use a semaphore to
;; ensure that multiple threads do not update at the same time.
;;
;; The semaphore-wait and -post are performed by each planet's loop
;; method, bracketing the calls to "calculate-force" and "move".
;;
;; Provided:
...
(define planet%
  (class object%
    ...
    ;; The position loop, now with semaphore-waiting and -posting.
    (define (loop)
